...
namespace PaperCraft
{
    public static class BoundingSphereRenderer
    {
        ...
        public static void InitializeGraphics(GraphicsDevice _graphicsDevice, int sphereResolution)
        {
            ...
            Color yzColor)
        {
            ...
            {
                Render(sphere, view, projection, xyColor, xzColor, yzColor);
            }
        }
            ...
            Color color)
        {
            foreach (BoundingSphere sphere in spheres)
            {
                Render(sphere, view, projection, color);
            }
        }
